...
class Mobile extends Component {
    constructor() {
        ...
        this.state = {
            dropDownVal: `${this.dropList[0].code}​​​​​​​​`,
            selectedCountryCode: this.dropList[0].code,
            countryList: this.dropList,
            searchQuery: ''
        }
    }
    onSelect = (eventKey) => {
        console.log(eventKey);
        const selectedCountry = this.dropList.find(list => list.code === eventKey);
        console.log('---selectedCountryCode--', selectedCountry);
        this.setState({
            dropDownVal: `${selectedCountry.code}​​​​​​​​`,
            selectedCountryCode: eventKey,
            searchQuery: '',
            countryList: this.dropList
        })
    }
    ...
    render() {
        ...
        return (
            <Form.Group controlId="formBasicEmail">
                ...
                <Dropdown as={ButtonGroup} onSelect={this.onSelect}>
                    <Dropdown.Toggle variant="light" id="dropdown-custom-1">{this.state.dropDownVal}</Dropdown.Toggle>
                    <Dropdown.Menu className="demo1" style={{ width: '20rem' }}>
                        ...
                        {this.state.countryList.length > 0 ? this.state.countryList.map(list =>
                            <Dropdown.Item 
                                key={list.id} 
                                eventKey={list.code} 
                                active={this.state.selectedCountryCode === list.code}>
